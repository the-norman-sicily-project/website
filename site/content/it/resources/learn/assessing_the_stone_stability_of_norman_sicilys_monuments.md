...
* *Valutazione Formativa:* [La Forma (la pietra)](la_forma_(la_pietra).docx)
* *Valutazione Sommativa:* [Valutazione Sommativa (la pietra)](valutazione_sommativa_(la_pietra).docx)
...
|---|---|---|
| 10 minuti | Istruisce gli studenti ad aprire i loro portatili o gli smartphone e li da’ un link alla forma google (valutazione formativa). | Tirano i loro portatili o gli smartphone e rispondono le domande dalla forma google. |
| 15 minuti | Dà lezioni sul tema includendo l’architettura e il CSSI. Fa disponibile la presentazione da diapositive agli studenti così possono partecipare con la lezione come sta avanzando. | Ascoltano alla presentazione e prendono appunti (facoltativo). Imparano dell’architettura siciliana normanna e il CSSI.  |
| 30 minuti | Inizia le istruzioni dell'attività di CSSI. Ha gli studenti cliccano il link dalla presentazione. Presenta lo slide con la foto essendo valutato sullo schermo. Cammina in giro la classe di vedere e aiutare quando è necessario.  | Scaricano e modificano il PDF di CSSI e valutano la struttura della pietra. Possono lavorare solo o fanno coppia.  |
