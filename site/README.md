This webpage is made using hamburg as a base for the code
...
When wanting to make a heading in markdown use #'s 1 for the biggest 3 for the smallest or ======== under the word you intend to make a heading
...
when making anew blog post you must add said post to the "posts section" under content. use the same front matter and make sure to add a summary in order to have a post title



## closing remarks

If you wish to add a video playable on a page you must use html as opposed to that of markdown. instead of markdown with this being the basic layout

<head>
      <title>Title</title>
   </head>
   <body>
      <p>where to write what you want, to make a new paragraph copy the p and /p into a new line with the same prior formating</p>
      <br />
      <iframe width="560" height="315" src="link" frameborder="0" allowfullscreen></iframe>
   </body>
</html>

to link in markdown use this format [name of link](link "word to show")
